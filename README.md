...
Hi 👋
I am **Sunal Rajput**, an aspiring **Data Analyst / Analytics Engineer** with strong interest in **data warehousing, SQL, and analytics engineering**.
...
This project is licensed under the **MIT License**. You are free to use, modify, and learn from it with proper attribution.
